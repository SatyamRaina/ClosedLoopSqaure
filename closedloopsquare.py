...
class DuckiebotSquareDriver:
    def __init__(self):
        ...
        self.pub = rospy.Publisher('/<duckiebot_name>/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=2)
        rospy.Subscriber('/<duckiebot_name>/fsm_node/mode', FSMState, self.fsm_callback, queue_size=1)
